...
static inline def_DHelper(IS) {
  decode_op_r(s, id_src1, s->isa.instr.i.rs1, false);
  decode_op_i(s, id_src2, (sword_t)s->isa.instr.i.simm11_0&0X03F, false);
  decode_op_r(s, id_dest, s->isa.instr.i.rd, true);
}

static inline def_DHelper(ISW) {
  decode_op_r(s, id_src1, s->isa.instr.i.rs1, false);
  decode_op_i(s, id_src2, (sword_t)s->isa.instr.i.simm11_0&0X01F, false);
  decode_op_r(s, id_dest, s->isa.instr.i.rd, true);
}
...
def_THelper(arithi_sub1){
  def_INSTR_IDTAB("000000? ????? ????? ??? ????? ????? ??", IS,slli);
  return EXEC_ID_inv;
}

def_THelper(arithi_sub5){
  def_INSTR_IDTAB("010000? ????? ????? ??? ????? ????? ??", IS,srai);
  def_INSTR_IDTAB("000000? ????? ????? ??? ????? ????? ??", IS,srli);
  return EXEC_ID_inv;
}

def_THelper(arithi){
  def_INSTR_TAB("??????? ????? ????? 000 ????? ????? ??", addi);
  def_INSTR_TAB("??????? ????? ????? 001 ????? ????? ??", arithi_sub1);
...
def_THelper(arithw_sub1){
  def_INSTR_TAB("0000000 ????? ????? ??? ????? ????? ??", sllw);
  return EXEC_ID_inv;
}

def_THelper(arithw_sub4){
  def_INSTR_TAB("0000001 ????? ????? ??? ????? ????? ??", divw);
  return EXEC_ID_inv;
}
...
def_THelper(arithw_sub6){
  def_INSTR_TAB("0000001 ????? ????? ??? ????? ????? ??", remw);
  return EXEC_ID_inv;
}
def_THelper(arithw_sub7){
  def_INSTR_TAB("0000001 ????? ????? ??? ????? ????? ??", remuw);
  return EXEC_ID_inv;
}

def_THelper(arithw){
  def_INSTR_TAB("??????? ????? ????? 000 ????? ????? ??", arithw_sub0);
  def_INSTR_TAB("??????? ????? ????? 001 ????? ????? ??", arithw_sub1);
  def_INSTR_TAB("??????? ????? ????? 101 ????? ????? ??", arithw_sub5);
  def_INSTR_TAB("??????? ????? ????? 100 ????? ????? ??", arithw_sub4);
  def_INSTR_TAB("??????? ????? ????? 110 ????? ????? ??", arithw_sub6);
  def_INSTR_TAB("??????? ????? ????? 111 ????? ????? ??", arithw_sub7);
  return EXEC_ID_inv;
}

def_THelper(arithwi_sub1){
  def_INSTR_IDTAB("0000000 ????? ????? ??? ????? ????? ??", ISW, sllwi);
  return EXEC_ID_inv;
}

def_THelper(arithwi_sub5){
  def_INSTR_IDTAB("0000000 ????? ????? ??? ????? ????? ??", ISW, srlwi);
  def_INSTR_IDTAB("0100000 ????? ????? ??? ????? ????? ??", ISW, srawi);
  return EXEC_ID_inv;
}

def_THelper(arithwi){
  def_INSTR_TAB("??????? ????? ????? 000 ????? ????? ??",  addwi);
  def_INSTR_TAB("??????? ????? ????? 001 ????? ????? ??", arithwi_sub1);
  def_INSTR_TAB("??????? ????? ????? 101 ????? ????? ??", arithwi_sub5);
  return EXEC_ID_inv;
}

def_THelper(arith_sub0){
...
def_THelper(arith_sub2){
  def_INSTR_TAB("0000000 ????? ????? ??? ????? ????? ??", slt);
  return EXEC_ID_inv;
}

def_THelper(arith_sub3){
...
def_THelper(arith){
  def_INSTR_TAB("??????? ????? ????? 000 ????? ????? ??", arith_sub0);
  def_INSTR_TAB("??????? ????? ????? 001 ????? ????? ??", arith_sub1);
  def_INSTR_TAB("??????? ????? ????? 010 ????? ????? ??", arith_sub2);
  def_INSTR_TAB("??????? ????? ????? 011 ????? ????? ??", arith_sub3);
  def_INSTR_TAB("??????? ????? ????? 100 ????? ????? ??", arith_sub4);
  def_INSTR_TAB("??????? ????? ????? 110 ????? ????? ??", arith_sub6);
  def_INSTR_TAB("??????? ????? ????? 111 ????? ????? ??", arith_sub7);
